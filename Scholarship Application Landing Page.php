        ...
        <div class="card">
            ...
            <div class="card-body">
                <blockquote class="blockquote mb-0 fs-3">
                    <p>This program provides financial assistance to students who meet the eligibility criteria. The financial assistance amounts to P10,000 per beneficiary.</p>
                </blockquote>
                <br>
                <blockquote class="fs-5">
                    <p>Are you:</p>
                    <ul>
                        <li>A student currently enrolled in an accredited institution</li>
                        <li>Not receiving any other scholarship or financial aid</li>
                        <li>Belonging to a family with a monthly income below P15,000</li>
                        <li>Maintaining a minimum GPA of 85%</li>
                    </ul>
                </blockquote>
                <br>
                <blockquote>
                    <p class="fw-bold fs-4">Documentary Requirements for Scholarship Assistance</p>
                    <p class="fst-italic fs-6">(Bring 1 original and 1 photocopy on the day of the appointment)</p>
                    <ul class="fs-5">
                        <li>Certificate of Enrollment</li>
                        <li>Latest School ID</li>
            ...
            <div class="card border-light mb-3" style="max-width: 100%; width: 60rem;">
                <div class="card-header fs-3 fw-bold text-center">FAQs on SCHOLARSHIP ASSISTANCE PROGRAM
                <div class="accordion" id="accordionOSSM">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="font-size: 1rem;">
                                What is the Scholarship Assistance Program?
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                            <div class="accordion-body" style="font-size: 1.15rem;">
                                The Scholarship Assistance Program is a government initiative designed to provide financial support to students who meet the eligibility criteria. This includes financial assistance for tuition fees, books, and other educational expenses.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="font-size: 1rem;">
                                Who qualifies for the Scholarship Assistance Program?
                            </button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                            <div class="accordion-body" style="font-size: 1.15rem;">
                                To qualify, you must be a student currently enrolled in an accredited institution, not receiving any other scholarship or financial aid, belong to a family with a monthly income below P15,000, and maintain a minimum GPA of 85%.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                            <div class="accordion-body" style="font-size: 1.15rem;">
                                <ul>
                                    <li><strong>Financial Assistance:</strong> Coverage for tuition fees, books, and other educational expenses.</li>
                                    <li><strong>Academic Support:</strong> Access to tutoring and mentoring services.</li>
                                    <li><strong>Career Guidance:</strong> Assistance with career planning and job placement.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header"></h2>
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" style="font-size: 1rem;">
                                How can I apply for the Scholarship Assistance Program?
                            </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                            <div class="accordion-body" style="font-size: 1.15rem;">
                                To apply, you need to visit your local social welfare office or apply online through the official government portal. You will be required to submit documentation such as proof of enrollment, proof of income, and other relevant documents.
                            </div>
                        </div>
                    </div>
            ...
            <div class="guide-container">
                ...
                <div class="card-body">
                    ...
                    <div class="step">
                        <p class="fw-bold fs-4 step-title">Step 2: Enter Educational Information</p>
                        <ul class="step-content">
                            <li>Current School</li>
                            <li>Grade Level or Year</li>
                            <li>Course (if applicable)</li>
                            <li>GPA</li>
                        </ul>
                    </div>
                    ...
                    <div class="step">
                        ...
                        <ul class="step-content">
                            <li>Name of Parents or Guardians</li>
                            <li>Occupation</li>
            ...
            <div class="wrap">
                <a href="Scholarship Application Form.php">
