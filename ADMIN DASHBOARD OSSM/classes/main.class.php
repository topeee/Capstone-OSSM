...
//------------------------------------------ DATABASE CONNECTION ----------------------------------------------------
    ...
    protected $server = "153.92.15.26";
    protected $user = "u271593949_ossmdb";
    protected $pass = "UcMPAq^5";
    protected $dbname = "u271593949_ossmdb"; // Add your database name here
