...
<body>
    ...
    <main>
        <div id="top-bar" class="top-bar-image d-flex justify-content-center align-items-center">
            <img src="sagw.jpg" class="minibanner" alt="Social And General Welfare">
        </div>
        ...
        <div class="card">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote mb-0 fs-3">
                            <p>Ang programang ito ay nagbibigay ng tulong pinansyal para sa mga indigent Solo Parent na may dalawa o higit pa na mga anak na nag-aaral sa pampublikong paaralan. Ang tulong pinansyal ay nagkakahalaga ng P5,000 para sa bawat benepisyaryo.</p>
                        </blockquote>
                        <br>
                        <blockquote class="fs-5">
                            ...
                            <ul>
                                <li>SOLO PARENT</li>
                                <li>Mayroong dalawa o mahigit na anak na nag-aaral ang solo parent</li>
                                <li>Anak na nag-aaral (enrolled sa public school)</li>
                        ...
                        <blockquote>
                            ...
                            <ul class="fs-5">
                                <li>Barangay Certificate of Indigency (Purpose: Solo Parent Assistance)</li>
                                <li>Certificate of Enrollment or latest school ID</li>
                                <li>QCID and Solo Parent/Certification</li>
                            </ul>
                        </blockquote>
                    </div>
                    ...
                    <br>
                        ...
                        <div class="card border-light mb-3" style="max-width: 100%; width: 60rem;">
                            <div class="card-header fs-3 fw-bold text-center">FAQs on SOLO PARENT ASSISTANCE PROGRAM</div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="font-size: 1rem;">
                                            What is the Solo Parent Assistance Program?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                                        <div class="accordion-body" style="font-size: 1.15rem;">
                                            The Solo Parent Assistance Program is a government initiative designed to provide financial and other forms of support to solo parents who are raising their children on their own. This includes educational assistance, livelihood training, and healthcare benefits.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="font-size: 1rem;">
                                            Who qualifies for the Solo Parent Assistance Program?
                                        </button>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                                        <div class="accordion-body" style="font-size: 1.15rem;">
                                            To qualify, you must be a solo parent as defined by law (e.g., due to death of spouse, legal separation, abandonment, etc.), have dependent children, and meet the income requirements specified by the program, typically for those in low-income brackets.
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                                        <div class="accordion-body" style="font-size: 115%;">
                                            <ul>
                                                ...
                                                <li><strong>Educational Assistance:</strong> Scholarships or school supplies for children.</li>
                                                <li><strong>Livelihood Support:</strong> Access to training programs and financial aid for small businesses.</li>
                                                <li><strong>Healthcare Benefits:</strong> Free or subsidized medical services for the solo parent and their children.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" style="font-size: 55%;">
                                            How can I apply for the Solo Parent Assistance Program?
                                        </button>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                                        <div class="accordion-body" style="font-size: 115%;">
                                            To apply, you need to visit your local social welfare office or apply online through the official government portal. You will be required to submit documentation such as proof of solo parenthood, proof of income, and other relevant documents.
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionOSSM">
                                        <div class="accordion-body" style="font-size: 115%;">
                                            ...
                                            <ul>
                                                ...
                                                <li>Certificate of Enrollment or School ID of the children</li>
                    ...
                    <br>
                        ...
                        <div class="guide-  container">
                            ...
                            <div class="card-body">
                                ...
                                <div class="step">
                                    <p class="fw-bold fs-4 step-title">Step 2: Do you have an existing Solo Parent ID number?</p>
                                    <ul class="step-content">
                                        <li>Yes: Enter Solo Parent ID Number</li>
                                        <li>No: Enter Sectoral Information</li>
                                        <ul>
                                            <li>Solo Parent Classification</li>
                                            <li>Monthly Income</li>
                                            <li>Total Income</li>
                                            <li>Problems of Solo Parent</li>
                                            <li>Problems of Solo Parent</li>
                                            <li>Family Resources</li>
                                            <li>Educational Attainment</li>
                                            <li>Name Of Company/Agent</li>
                                        </ul>
                                    </ul>
                                </div>
