...
<head>
    ...
    <title>Temporary Vending Site</title>
...
<body>
    ...
    <div class="container mt-4 mb-5">
        <div class="form-container mt-4 mb-5">
            <h1 class="text-center">Temporary Vending Site</h1>
                    ...
                    <form>
                        <div class="mb-3">
                            ...
                            <select class="form-select small-dropdown" id="marketSelect" aria-label="Vending Site Select">
                                ...
                                <option value="1">San Mateo Vending Site</option>
                                <option value="2">Sampaguita Vending Site</option>
                                <option value="3">Bambang Vending Site</option>
                                <option value="4">Nangka Vending Site</option>
                                <option value="5">Poblacion Vending Site</option>
                                <option value="6">Ampid Vending Site</option>
                            </select>
                        </div>
                    </form>
