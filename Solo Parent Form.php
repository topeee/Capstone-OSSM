...
<head>
  ...
  <style>
    ...
    .form-container {
      ...
      /* Keep form content background white */
    }
    ...
    .thin-rows td {
      ...
      /* Adjust as needed */
      padding: 5px;
      /* Optional: reduce padding to make it even thinner */
    }
            ...
            <tbody>
              <div class="form-section" style="border: 1px solid black; padding-right: 15px; padding-left: 15px; margin-top: 20px;">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-4 religion-field"><strong>Religion:</strong>
                  ...
                  <div class="col-4 birth-field"><strong>Birth Date:</strong> <span style="font-size: 0.7em; font-style: italic;">(MONTH/DD/YYYY)</span>
                    <p>________________________________</p>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-4 blood-field"><strong>Blood Type:</strong> <br>
                    <p>________________________________</p>
                  </div>
                  ...
                  <div class="col-4 place-field"><strong>Birth Place:</strong> <br>
                    <p>________________________________</p>
                  </div>
                </div>
              </div>
