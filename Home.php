            ...
            <div class="col">
                <ul class="list-inline my-2">
                    <li class="list-inline-item me-4">
                        <a href="https://www.facebook.com/sanmateorizalPIO" class="text-decoration-none">
                    ...
                    <li class="list-inline-item me-4">
                    <a href="https://www.youtube.com/@SanMateoRizal" class="text-decoration-none">
                        <div class="bs-icon-circle bs-icon-primary bs-icon"><svg class="bi bi-youtube" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
