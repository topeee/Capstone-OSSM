...
<head>
    ...
    <title>Business Applciation Permit</title>
</head>
    ...
    <main>
        ...
        <div class="card">
                    <div class="card-header fs-5">
                        Appy for Business Permit
                    </div>
                    <div class="card-body">
                        <blockquote class="blockquote mb-0 fs-3">
                            <p>Before applying for new business permit make sure to secure the following requirements below:</p>
                        </blockquote>
                        <br>
                        <blockquote class="fs-5">
                            ...
                            <ol>
                                <li><span style="color: red;">*</span> Proof of Business Registration(DTI for Sole Proprietorship and Partnerships/CDA for Cooperatives)</li>
                                <li><span style="color: red;">*</span> Contract of Lease (if leased) or Tax Declaration (if ownded)
                                    <h6>Reminders:</h6>
                                    <ol>
                                        <li>Contact of Least must be include TCT/Property Description</li>
                                        <li>Duly signed and notarized</li>
                                        <li>Contains/Indicates valid identity of lessor and lessse</li>
                                    </ol>
                                </li>
                                <li><span style="color: red;">*</span> Sketch and photos of location business
                                    <h6>Reminders:</h6>
                                    <ol>
                                        <li>Photos of the business location</li>
                                        <li>Front view of Business Establishment</li>
                                        <li>Area of Business Activity</li>
                                        <li>Street View of Business Establishment(Left)</li>
                                        <li>Street View of Business Establishment(Right)</li>
                                    </ol>
                                </li>
                                <li><span style="color: red;">*</span> ID of Owner</li>  
                            </ol>   
                            <br><br>
                            ...
                            <blockquote class="custom-notes mb-3">
                                <h2>Important Notes/Reminders:</h2>
                                <ol>
                                    <li>Subject to the Zoning Administration Unit's permissibility assessment</li>
                                    <li>Subject to the City Assessors Office's verification of title or authorization to utilize the property.</li>
                                    <li>Need to abide by national regulatory permissions and additional local auxiliary authorities.</li>
                                    <li>Travel agencies must provide an assurance bond.</li>
                                </ol>
                            </blockquote>                            
